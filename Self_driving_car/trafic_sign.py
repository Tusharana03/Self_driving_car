...
# sorting the data to respective variables
...
#Running the code only when the data is in correct format
...
# Displaying the samples randomly of the images and labels
...
# equalizing the image intensity
...
# Creating image generator function

from keras.preprocessing.image import ImageDataGenerator
datagen = ImageDataGenerator(width_shift_range=0.1 , height_shift_range=0.1 , zoom_range=0.2, shear_range=0.1,rotation_range=10)
datagen.fit(x_train)

# Visualizing image generator function 
...
# Evaluating model accuracy through a test data
...
# Testing the model with new images without any labels
